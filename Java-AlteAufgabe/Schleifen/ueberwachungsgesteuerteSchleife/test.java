...
public static void main(String[] args) {
		...
		System.out.println("Summe der Werte innerhalbe des Bereichs: " + summe1);	
		System.out.println("Summer der Werte ausserhalb des Berecihs: " + summe2);
